...
ActiveRecord::Schema[8.1].define(version: 2026_02_26_131831) do
  ...
  create_table "event_store_archive", primary_key: "sequence_number", force: :cascade do |t|
    t.string "aggregate_id", limit: 255, null: false
    t.string "aggregate_type", limit: 255, null: false
    t.timestamptz "archived_at", default: -> { "now()" }, null: false
    t.jsonb "body", null: false
    t.uuid "causation_id"
    t.uuid "correlation_id"
    t.timestamptz "created_at", default: -> { "now()" }, null: false
    ...
    t.timestamptz "occurred_at", null: false
    t.string "stream_id", limit: 512, null: false
    t.index ["archived_at"], name: "index_event_store_archive_on_archived_at"
    t.index ["id"], name: "index_event_store_archive_on_id", unique: true
    t.index ["occurred_at"], name: "index_event_store_archive_on_occurred_at"
  end
  ...
  create_table "transactions", force: :cascade do |t|
    ...
    t.string "detalles"
    t.boolean "en_cuotas", default: false, null: false
    ...
    t.string "origen", default: "definitivo", null: false
    t.string "red"
    t.string "sentimiento"
